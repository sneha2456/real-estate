<?php include_once("admin/Connection.php");
	...
	$select_query="select * from tblProperty where IsActive=1 AND IsPayment=1 and Status='Rent'";
                ...
                <div class="property-box-2" >
                    <div class="row">
                            ...
                            <div class="property-thumbnail">
                                <a href="properties-details.html" class="property-img">
                                	  <!-- Select Project Image Query -->
                                        <?php
                                            $Select_image="select * from tblimage where IsActive=1 and PropertyID=".$fetch['PropertyID'];
                        ...
                        ?> 
                                ...
                                <ul class="facilities-list clearfix" style="background-color: none;background: rgba(0, 0, 0, 0);" >
                                    <li>
