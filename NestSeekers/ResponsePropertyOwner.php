...
<?php
      ...
      $selectProperty="select * from tblProperty where PropertyID=".$_REQUEST['PropertyID'];
      $ExeProperty=mysqli_query($con,$selectProperty) or die(mysqli_error($con));
      $fetchProperty=mysqli_fetch_array($ExeProperty);
                    ...
                    <div class="submit-address dashboard-list">
                        <form method="GET">
                           ...
                           <?php
                                ...
                                if($fetchProperty['IsApprovedByAgent']==1)
                                {
                                     $selectResponse="SELECT tblUser.*,tblResponse.ResponseID,tblResponse.IsResponseAgent, tblResponse.ResponseType, tblResponse.ResponseUserID,tblResponse.ResponseUserName,tblResponse.ResponseUserEmail,tblResponse.ResponseContactNo,tblResponse.IsApproved as IsApprovedBySeller,tblResponse.Message,tblResponse.CreatedOn as ContactDate
                                            FROM tblUser
                                            INNER JOIN tblResponse ON tblUser.UserID = tblResponse.ResponseUserID
                                            WHERE tblResponse.IsActive=1 AND tblResponse.ResponseType='A' AND tblResponse.IsResponseAgent=1 AND tblResponse.IsApproved=0 AND  tblResponse.PropertyID=".$PropertyID;
                                $Execute_Response=mysqli_query($con,$selectResponse) or die(mysqli_error($con));
                                }
                                else
                                {
                                         $selectResponse="SELECT tblUser.*,tblResponse.ResponseID, tblResponse.ResponseType, tblResponse.ResponseUserID,tblResponse.ResponseUserName,tblResponse.ResponseUserEmail,tblResponse.ResponseContactNo,tblResponse.IsApproved as IsApprovedBySeller,tblResponse.Message,tblResponse.CreatedOn as ContactDate
                                            FROM tblUser
                                            INNER JOIN tblResponse ON tblUser.UserID = tblResponse.ResponseUserID
                                    ...
                                    <div class="comment">
                                        ...
                                        <div class="comment-content">
                                            ...
                                            <div class="buttons mb-20">
                                                <a href="?ResponseID=<?php echo $fetch['ResponseID'];?>&ResponseUserID=<?php echo $fetch['ResponseUserID'];?>&PropertyID=<?php echo $PropertyID;?>&IsApprove=1" class="btn-1 btn-gray"><i class="fa fa-fw fa-check-circle-o"></i> Approve / Sell</a>
