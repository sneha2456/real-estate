                    ...
                    <div class="dashboard-content">
                        ...
                        <div class="dashboard-list">
                            ...
                            <!-- Fetch Property Of User -->
                                ...
                                $Select_Property="SELECT * FROM tblProperty WHERE IsActive=1 AND UserID='".$_SESSION['UserID']."'";
                        ...
                        ?> >
                                    ...
                                    <td class="title-container">
                                        ...
                                        <h2>
                                             <?php  if($Fetch_Property['IsPayment']==0)
                                                        {
                                                            echo "<marquee style='color:red;'><i><b>Payment is Remain, Pay Now To Active Your Post.</b></i></marquee>";
                                                        }
                                ...
                                ?>
                                        ...
                                        <a href="?DeleTePropertyID=<?php  echo $Fetch_Property['PropertyID']; ?>" class="delete"><i class="fa fa-remove"></i> Delete</a>
                                         <?php  if($Fetch_Property['IsPayment']==0)
                                                        {
                                                        ?>
                                                            <a href="propertyPayment.php?PropertyID=<?php  echo $Fetch_Property['PropertyID']; ?>" ><i class="fa  fa-money "></i> Pay Now</a>
                                                        <?php
                                                        }
