<?php include_once("admin/Connection.php");
	...
	$select_query="select * from tblProperty where IsActive=1 and PropertyTypeID = ".$_REQUEST['PropertyTypeID'];
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12">
                ...
                if(isset($_REQUEST['btnwishlist']))
                {
                    if(isset($_SESSION['UserID']))
                    {
                            $UserID = $_SESSION['UserID'];
                    $insert_query="insert into tblwishlist values(null,now(),$UserID,'".$fetch['PropertyID']."',1)";
