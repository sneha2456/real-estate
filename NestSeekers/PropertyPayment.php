...
/*Fetch membership amount*/
    ...
    $_SESSION['NewPropertyID']=$PropertyID;
    $selectPropertyDetails="SELECT tblProperty.*, tblPackage.*,tblUser.FirstName,
                            tblUser.lastname
                             FROM tblProperty 
    ...
    $Exe_Property=mysqli_query($con,$selectPropertyDetails) or die(mysqli_error($con));
    $FetchProperty=mysqli_fetch_array($Exe_Property);
...
<div class="sub-banner overview-bgi">
    <div class="container">
        <div class="breadcrumb-area">
            <h1>Property Plan Payment</h1>
            <ul class="breadcrumbs">
                <li><a href="index.php">Home</a></li>
                <li class="active">Property Plan Payment</li>
            </ul>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1" style="padding: 100px;">
                <div class="contact-2">
                    ...
                    <h3 class="heading-2"> Payment Details</h3>
                    <form action="#" method="GET" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group name">
                                    <input type="text" name="txtPropertyID" class="form-control" placeholder="Name" style="border-left-width: 3px;border-left-color: #ff214f;" value="<?php echo $FetchProperty['PropertyID'];?>" readonly="">
                                </div>
                                <div class="form-group email">
                                    <input type="email" name="txtPropertyName" class="form-control" placeholder="Email" style="border-left-width: 3px;border-left-color: #ff214f;" value="<?php echo $FetchProperty['PropertyTitle'];?>" readonly="">
                                </div>
                                <div class="form-group number">
                                    <input type="text" name="txtUserName" class="form-control" placeholder="Number" value="<?php echo $FetchProperty['FirstName']." ".$FetchProperty['lastname'];?>" style="border-left-width: 3px;border-left-color: #ff214f;" readonly="">
                                </div>
                                <div class="form-group number">
                                    <input type="number" name="amount" class="form-control" placeholder="Amount" value="<?php echo $FetchProperty['PlanPrice'];?>" style="border-left-width: 3px;border-left-color: #ff214f;" readonly="">
                                </div>
                                        ...
                                        <div class="col-xl-8 col-lg-8 col-md-8">
                                          <div class="pricing-1 plan">
                                              <div class="plan-header">
                                                  <h5><?php echo $FetchProperty['PackageName'];?></h5>
                                                  <p>Plan short description</p>
                                                  <div class="plan-price"><sup>₹</sup><?php echo $FetchProperty['PlanPrice'];?><span>only</span> </div>
                                              </div>
                                              <div class="plan-list">
                                                  <ul>
                                                      <li><i class="fa  fa-long-arrow-up"></i><?php echo $FetchProperty['HigherPossition'];?>%  Higher Possition</li>
                                                      <li><i class="fa fa-globe"></i><?php echo $FetchProperty['Day'];?> Days Online</li>
                                                      <li><i class="fa fa-thumbs-up"></i><?php echo $FetchProperty['GetMobileNoOfBuyers'];?> </li>
               ...
               <!--  <div style="margin-top: 100px;margin-left: 400px;">
                    ...
                    <table>
                       ...
                       <!--  <tr>
                        ...
                        <tr>
                          <td>Success URL <span class="mand">*</span>: </td>
                          <td colspan="3"> --><input type="hidden" name="surl" value="<?php echo (empty($posted['surl'])) ? $currentDir.'successPropertyPayment.php' : $posted['surl'] ?>" size="64" /><!-- </td>
                        </tr>
                        <tr>
                          <td>Failure URL <span class="mand">*</span>: </td>
                          <td colspan="3"> --><input type="hidden" name="furl" value="<?php echo (empty($posted['furl'])) ? $currentDir.'failurePropertyPayment.php' : $posted['furl'] ?>" size="64" /><!-- </td>
                        </tr>
