<?php
	/* $select="select * from tbl Property where Status='".$_REQUEST['Status']."', PropertyTypeID='".$_REQUEST['cmbType']."', BedRoomID='".$_REQUEST['cmbBedRoom']."',BathRoomID='".$_REQUEST['cmbBathRoom']."',CityID='".$_REQUEST['cmbCity']."'";
               echo $select;*/
?>
...
<?php include_once("admin/Connection.php");
	...
	/*$select_query="select * from tblProperty where (Status='".$_REQUEST['Status']."' OR Status=='null') AND (PropertyTypeID='".$_REQUEST['cmbType']."' OR PropertyTypeID=='null') AND (BedRoomID='".$_REQUEST['cmbBedRoom']."' OR BedRoomID=='null') AND (BathRoomID='".$_REQUEST['cmbBathRoom']."' OR BathRoomID=='null') AND (CityID='".$_REQUEST['cmbCity']."' OR CityID=='null') AND IsActive=1 ";*/
    $select_query="SELECT * FROM tblProperty WHERE (Status='".$_REQUEST['Status']."' OR Status Is NULL) AND (PropertyTypeID='".$_REQUEST['cmbType']."' OR PropertyTypeID Is NULL) AND (BedRoomID='".$_REQUEST['cmbBedRoom']."' OR BedRoomID Is NULL) AND (BathRoomID='".$_REQUEST['cmbBathRoom']."' OR BathRoomID Is NULL) AND (CityID='".$_REQUEST['cmbCity']."' OR CityID Is NULL) AND IsActive=1 ";
