<?php include_once("admin/Connection.php");
	...
	$select_query="SELECT * FROM tblProperty WHERE IsActive=1 AND IsPayment=1 AND Status='Sale'  ORDER BY PackageID DESC,PropertyDetailStatus DESC, CreatedOn DESC";
                            ...
                            <div class="property-thumbnail">
                                <a href="properties-details.html" class="property-img">
                                    ...
                                    <!-- select Agent Price-->
                                        ...
                                        ?>
                                            <div class="price-box"><i class="fa  fa-inr"></i> <?php if(isset($fetchSelAgent)) echo $fetchSelAgent['Price']; ?> <span style="color: #ff214f;">INR</span></div>

                                        <?php
                                        }
                                        else{
                                            ?>
                                                <div class="price-box"><i class="fa  fa-inr"></i> <?php if(isset($fetch)) echo $fetch['ExpectedPrice']; ?> <span style="color: #ff214f;">INR</span></div>
                                            <?php
                                        }
